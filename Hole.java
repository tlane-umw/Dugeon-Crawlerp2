/**The Hole class is the locations of the secret locations in the Dungeon. If the player digs in one of these locations locations they exit the Dungeon and beat the game.
