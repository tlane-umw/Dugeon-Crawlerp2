...
public class ItemGenerator{
	...
	public static Item generate(){
		...
		Item sword = new Item("Sword", 50, 25, 75, ItemType.Weapon);
		Item fineSword = new Item("Fine Sword", 60, 35, 85, ItemType.Weapon);
		Item fineSteelSword = new Item("Fine Steel Sword", 80, 55, 105, ItemType.Weapon);
		...
		Item shield = new Item("Shield", 40, 30, 60, ItemType.Armor);
		Item fineSteelShield = new Item("Fine Steel Shield", 65, 55, 85, ItemType.Armor);
		Item bodyArmor = new Item("Body Armor", 85, 75, 105, ItemType.Armor);
		...
		Item key = new Item("Key", 10, 5, 0, ItemType.Other);
		Item vase = new Item("Vase", 7, 3, 0, ItemType.Other);
		Item pokeball = new Item("PokeBall", 2, 20, 0, ItemType.Other);
